...
* _Requisitions_ allow to build monitoring profiles, e.g. Mailserver with detectors for SMTP
* Monitoring profile for web server with detectors for HTTP
* _Policies_ can be assigned to _Requistions_, z.B. sort Nodes based on rules into categories
...
* _Provisiond_ investiates new suspect IP adressses with detectors and SNMP
